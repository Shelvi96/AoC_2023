...
def part_one(input_map: Map, starting_node: str) -> int:
	current_node = starting_node
	target_node = "ZZZ"
	instruction_idx = 0
	steps_count = 0
	while current_node != target_node:
		current_node = input_map.network[current_node][0] if input_map.instruction[instruction_idx] == "L" else input_map.network[current_node][1]
		steps_count += 1
...
if __name__ == "__main__":
	...
	print(f"Part one: {part_one(input_map=input_map, starting_node='AAA')}")
